...
If you want to know how many different sizes per gene there are
```{r sizesPer}
sizesPerGene(Info)
sizesPerPathway(Info)
sizesPerPathway(gss)
...
sizesPerGene is the equivalent of counting how many rows are not empty on the `sizeGenes` matrix
